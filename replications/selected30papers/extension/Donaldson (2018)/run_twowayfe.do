/*=============================================================================
  ...
  >>> TARGET TABLE: Main Table 3 (see extension/instructions.md).
  >>> The spec below currently estimates Table 4, Col 1.
  >>> Retarget the regression to Table 3 before re-running.

  Main TWFE spec: Table 4, Column 1                    [TO RETARGET → Table 3]
...
local texdir "${twfe_root}/replications/2015-2019/Donaldson (2018)"
