/*==============================================================================
  ...
  >>> TARGET TABLES: Main Tables 1 AND 2 (see extension/instructions.md).
  >>> The pipeline below currently replicates Table 1 only.
  >>> Add a Step 2b that estimates Table 2 before re-running.

  Pipeline:
    STEP 1: Data exploration & verification
    STEP 2: Replicate Table 1 Col 1 (baseline TWFE)
    STEP 2b: [TO ADD] Replicate Table 2
