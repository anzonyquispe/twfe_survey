/*=============================================================================
  ...
  >>> TARGET TABLE: Main Table 2 (see extension/instructions.md).
  >>> The spec below currently estimates Table 4, Col 1.
  >>> Retarget the regression to Table 2 before re-running.

  Main TWFE spec: Table 4, Column 1                    [TO RETARGET → Table 2]
...
local texdir "${twfe_root}/replications/2015-2019/Favara and Imbs (2015)"
