/*==============================================================================
  ...
  >>> TARGET TABLE: Main Table 1 (see extension/instructions.md).
  >>> The pipeline below currently estimates Table 2 / Table 4 Col 5.
  >>> Retarget Step 2 to Table 1 before re-running.

  Pipeline:
    STEP 1: Data exploration & verification
    STEP 2: Replicate Table 2 main regression          [TO RETARGET → Table 1]
