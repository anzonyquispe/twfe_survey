/*==============================================================
  Replicacion: Hainmueller & Hangartner (2019) AJPS
  Equivalente a: papers/Hainmueller_Hangartner_2019.R

  Y:      nat_rate_ord
  D:      indirect
  Unit:   bfs (puede ser string -> encode a numerico)
  Time:   year
  FE paper original: bfs + year
...
use "data/polisci/data_hainmueller.dta", clear

* bfs: convertir a numerico si es string (equivalente a as.numeric(factor()))
cap confirm string variable bfs
if !_rc {
    encode bfs, gen(unit_num)
    drop bfs
}
else {
    egen unit_num = group(bfs)
}

* year ya es numerico

* Variables principales
local Y "nat_rate_ord"
local D "indirect"
...
*==============================================================
* 1. TWFE REPORTADO (FE del paper: bfs + year)
*    R: feols(nat_rate_ord ~ indirect | bfs + year, cluster = "bfs")
*==============================================================
...
save "$path/replications/polisci/output/hainmueller_estimates.dta", replace

di ""
di "============================================"
di "  RESULTADOS FINALES: Hainmueller & Hangartner (2019)"
di "============================================"
