/* Test: SA para Esberg - rango COMPLETO (-82 a 75) */
...
* Rango COMPLETO sin cap
summ rel_time if treat == 1
local tmin = r(min)
local tmax = r(max)
di "Rango COMPLETO: `tmin' a `tmax'"
...
di "=== Comenzando eventstudyinteract (rango completo) ==="
