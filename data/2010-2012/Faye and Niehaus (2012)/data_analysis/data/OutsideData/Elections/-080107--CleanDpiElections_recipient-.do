    ...
    ************************************************
    ...
    clear
    use "/export/projects/aidflow_project/OutsideData/Elections/dpi2004_missing.dta"
...
local date=080107
   ...
   gen i_execcenter=.
   replace i_execcenter=1 if execrlc=="C"
   replace i_execcenter=0 if execrlc=="L" | execrlc=="R"
   ...
   label var i_execcenter "Indicator of whether executive is member of center party"
    ...
    *****************************************************
    ...
    keep recipientname wbcode year *_ex date* prtyin percent* allhouse exelec legelec execnat gov1nat opp1nat  execrlc gov1rlc opp1rlc i_execopp_diff i_execright i_execleft i_execcenter eiec finittrm fraud
    ...
    *****************************************************
    ...
    cd "/export/projects/aidflow_project/OutsideData/"
    ...
    cd "/export/projects/aidflow_project/OutsideData/Elections/"
    ...
    **********************************************************
    ...
    local elections="/export/projects/aidflow_project/OutsideData/Elections/"
    cd "`elections'"
    ...
    **********************************************************
    ...
    label var eiec "Binary index of competitvness (1: eiec>3, 0: eiec<=3)"
    ...
    **********************************************************
    ...
    sort wbcode_r year
    drop legelec exelec recipientcode country_recipient m  i_elecex_old recipient dataset
