...
xi:  xtivreg logmd (ljlten = ic* int1-int6 ) agey agey2 agey3 educ atota atota2 male i.race married hhres i.cendiv w4 w56 if agey>=66 & wave>=3, re 
xi:  xtivreg mhs2  (ljlten = ic* int1-int6 ) agey agey2 agey3 educ atota atota2 male i.race married hhres i.cendiv w4 w5 if agey>=66 & wave>=3, re
