*quietly {
* Program Name : bystateandaddress1.do
...
*******************************************************************************
*
*	Merge by STATE and First X CHARACTERS of Address 1
*
*******************************************************************************


* STATE and Address1 matching loop
******************************
...
forvalues j=$J/38 {
	local i=41-`j'
	noi di
	noi di in green "Performing Matching by STATE and first " `i' " characters of Bussiness Address1...."
	...
	saveold `pathcensus'mergebyaddress1andstate_`i', replace
	keep naeyc_id
	sort naeyc_id
	merge naeyc_id using `pathnaeyc'naeyc_notmatched.dta
	tab _merge
