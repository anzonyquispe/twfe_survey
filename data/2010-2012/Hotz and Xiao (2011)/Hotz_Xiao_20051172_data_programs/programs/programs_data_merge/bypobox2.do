...
*******************************************************************************
*
*	Merge by 5-digit Zip Code and Exact P.O. BOX number (based on Address2)
*
*******************************************************************************


	noi di
	noi di in green "Performing Matching by Zip and exact P.O.Box 2 number  ...."
...
*keep if _merge==3	
	...
	sort zip pobox year
	merge zip pobox using `pathnaeyc'naeyc_clean.dta,  _merge(mergebypobox2)
	tab mergebypobox2
	keep if mergebypobox2==3
	keep census_rec naeyc_id
	saveold `pathcensus'mergebypobox2, replace
	keep naeyc_id
	sort naeyc_id
	merge naeyc_id using `pathnaeyc'naeyc_notmatched.dta
	tab _merge
