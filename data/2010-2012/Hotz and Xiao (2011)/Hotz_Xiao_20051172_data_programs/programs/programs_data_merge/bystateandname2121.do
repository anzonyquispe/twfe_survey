quietly {
* Program Name : bystateandname2121.do
...
*******************************************************************************
*
*	Merge by STATE and First X CHARACTERS of Bussiness Name 2121
*
*******************************************************************************


* STATE and Business name 2121 matching loop
*********************************************
...
forvalues j=$J/38 {
	local i=41-`j'
	noi di
	noi di in green "Performing Matching by STATE and first " `i' " characters of Bussiness Name 2121...."
	...
	saveold `pathcensus'mergebyname2121andstate_`i', replace
	keep naeyc_id
	sort naeyc_id
	merge naeyc_id using `pathnaeyc'naeyc_notmatched.dta
	tab _merge
