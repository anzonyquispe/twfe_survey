...
*******************************************************************************
*
*	Merge by 5-digit Zip Code and first X CHARACTERS of Name2112
*
*******************************************************************************

* Zip and Name2112 matching loop
********************************
...
forvalues j=$J/38 {
	local i=41-`j'+3
	noi di
	noi di in green "Performing Matching by Zip and first " `i' " characters of Bussiness Name 2112...."
	...
	*Takes care of "The" issue in center names
	...
	saveold `pathcensus'mergebyname2112_`i', replace
	keep naeyc_id
	sort naeyc_id
	merge naeyc_id using `pathnaeyc'naeyc_notmatched.dta
	tab _merge
