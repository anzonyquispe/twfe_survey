quietly {
* Program Name : bystateandname1221.do
...
*******************************************************************************
*
*	Merge by STATE and First X CHARACTERS of Bussiness Name 1221
*
*******************************************************************************

* STATE and Name1221 matching loop
******************************
...
forvalues j=$J/38 {
	local i=41-`j'
	noi di
	noi di in green "Performing Matching by STATE and first " `i' " characters of Bussiness Name 1221...."
	...
	saveold `pathcensus'mergebyname1221andstate_`i', replace
	keep naeyc_id
	sort naeyc_id
	merge naeyc_id using `pathnaeyc'naeyc_notmatched.dta
	tab _merge
