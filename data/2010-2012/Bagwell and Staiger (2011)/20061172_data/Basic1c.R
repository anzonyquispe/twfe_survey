...
write.table(cd,"C:/TOT_Project/Estimation Code/Baseline Estimates/Results/Basic2.TXT",row.names=FALSE, col.names = FALSE, append=FALSE)
...
write.table(cd2,"C:/TOT_Project/Estimation Code/Baseline Estimates/Results/Basic2.TXT",row.names=FALSE, col.names = FALSE, append=TRUE)
