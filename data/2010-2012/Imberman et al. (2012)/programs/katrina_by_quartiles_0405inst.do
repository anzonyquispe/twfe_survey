...
save /work/i/imberman/imberman/katrina_0405school.dta, replace
...
foreach grade in "elem" "midhigh"{
  ...
  *IDENTIFY THE 0405 SCHOOL
  gen campus_0405 = .
  replace campus_0405 = l.campus if year == 2005
  replace campus_0405 = l2.campus if year == 2006
  
  *MERGE IN EVAC SHARE IN CURRENT GRADE FOR 0405 SCHOOL 
  sort campus_0405 grade year
  merge campus_0405 grade year using /work/i/imberman/imberman/katrina_0405school.dta, nokeep _merge(_merge0405)
  replace katrina_frac_0405school = 0 if year < 2005
