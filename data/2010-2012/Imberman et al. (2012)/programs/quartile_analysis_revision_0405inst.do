...
gen school00a=sitecode if year==2000
egen school00=max(school00a), by(id)

gen school01a=sitecode if year==2001
egen school01=max(school01a), by(id)

gen school02a=sitecode if year==2002
egen school02=max(school02a), by(id)

gen school03a=sitecode if year==2003
egen school03=max(school03a), by(id)

gen school0005=school0405
replace school0005=school03 if school0005==.
replace school0005=school02 if school0005==.
replace school0005=school01 if school0005==.
replace school0005=school00 if school0005==.
