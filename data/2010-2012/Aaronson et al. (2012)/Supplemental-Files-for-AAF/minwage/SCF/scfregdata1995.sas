...
data temp;
  ...
  *gaps = (5.50 - sinc - ssinc) / 5.50;
  gapr = (rinc + rsinc - 4.34) / 4.34;
  gaps = (sinc + ssinc - 4.34) / 4.34;
...
PROC EXPORT DATA=scfout.regressiondata95
            OUTFILE="C:\research\minwage\SCF\scfregdata95.csv"
            DBMS=csv REPLACE;
RUN;
