...
LIBNAME IN "C:\research\minwage\SCF\raw";
LIBNAME WORKINGR "C:\research\minwage\SCF\real2007";
LIBNAME WORKINGN "C:\research\minwage\SCF\nom2007";
...
%* specify here variables that are only to be kept for selected years;
  ...
  %IF (&PUBLIC EQ YES) %THEN %LET KEEPLIST=&ALSOKEEP
    ...
    FAMSTRUCT OCCAT2 HBUS 
    /* Additional variables for Minwage paper */
    X3103 X4106 X3104 X3119 x5702 x5710 x5712 x5704 
    x4131 x4731 X4112 X4712 x3337 x3132 x3232 x3332 X8022 X5901 X5909 X3107 X3119 X3118 X6403 x6809 X5902 X5904 X3108 
    X3123 X3124 X3125 X3126 x5714 x4125 x5709 x5707 x4113 nfin2 vehic2 houses2 oresre2 nnresre2 bus2 othfin2 
    X4110 X4111 x4713 x4732 x4132 x4711 x5703 X4732 X4713 X5706 X5708 x4710 x3128 x3131 x3231 x3331 x3132 
    x3232 x3332 x3110 x3120 x3121 X3006 X3007 X7513 X7514 X7515 X6848 X7131 X407 X7584 x3014 x3129 x3229 
    x3329 x3130 x3230 x3330 x3111 x3113 x3114 x3115 x3116 x3117
    x410 x7020
    &ALSOKEEP; 
  ...
  %ELSE %LET KEEPLIST=&ALSOKEEP WGT0 WGT X1 XX1 WILSH MARRIED KIDS
    ...
    CKPERSONAL CKCONNECTN CKLONGTIME CKSAFETY CKCONVPAYRL CKOTHCHOOSE 
    /* Additional variables for Minwage paper */
    X3103 X4106 X3104 X3119 x5702 x5710 x5712 x5704 x4131 x4731 X4112 X4712 x3337 
    x3132 x3232 x3332 X8022 X5901 X5909 X3107 X3119 X3118 X6403 x6809 X5902 X5904 X3108 
    X3123 X3124 X3125 X3126 x5714 x4125 x5709 x5707 x4113 nfin2 vehic2 houses2 oresre2 nnresre2 bus2 othfin2 
    X4110 X4111 x4713 x4732 x4132 x4711 x5703 X4732 X4713 X5706 X5708 x4710 x3128 x3131 x3231 x3331 x3132 
    x3232 x3332 x3110 x3120 x3121 X3006 X3007 X7513 X7514 X7515 X6848 X7131 X407 X7584 x3014 x3129 x3229 
    x3329 x3130 x3230 x3330 x3111 x3113 x3114 x3115 x3116 x3117 
