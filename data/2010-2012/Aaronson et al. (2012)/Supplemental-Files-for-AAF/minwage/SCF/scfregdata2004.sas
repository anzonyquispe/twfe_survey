...
data temp;
  ...
  *gaps = (5.50 - sinc - ssinc) / 5.50;
  gapr = (rinc + rsinc - 5.51) /5.51;
  gaps = (sinc + ssinc - 5.51) /5.51;
...
PROC EXPORT DATA=scfout.regressiondata04
            OUTFILE="C:\research\minwage\SCF\scfregdata04.csv"
            DBMS=csv REPLACE;
RUN;
