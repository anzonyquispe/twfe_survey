...
data temp;
  ...
  *gaps = (5.50 - sinc - ssinc) / 5.50;
  gapr = (rinc + rsinc - 3.48) / 3.48;
  gaps = (sinc + ssinc - 3.48) / 3.48;
...
PROC EXPORT DATA=scfout.regressiondata89
            OUTFILE="C:\research\minwage\SCF\scfregdata89.csv"
            DBMS=csv REPLACE;
RUN;
