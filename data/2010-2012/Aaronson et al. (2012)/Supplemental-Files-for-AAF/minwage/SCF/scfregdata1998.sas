...
data temp;
  ...
  *gaps = (5.50 - sinc - ssinc) / 5.50;
  gapr = (rinc + rsinc - 5.19) / 5.19;
  gaps = (sinc + ssinc - 5.19) / 5.19;
...
PROC EXPORT DATA=scfout.regressiondata98
            OUTFILE="C:\research\minwage\SCF\scfregdata98.csv"
            DBMS=csv REPLACE;
RUN;
