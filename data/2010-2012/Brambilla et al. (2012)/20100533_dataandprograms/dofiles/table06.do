...
* -- Panel B1
********************************************************************************************************
local outpath="`root'"+"/table6b.xls"
...
testparm $instruments
local r=r(p)
outreg2 lsales $instruments using `outpath', append `opt' addstat("p-value", `r')
...
outreg2 $instruments using `outpath', append `opt' addstat("p-value", `r')
* Column 2
xi: xtreg $dependent $instruments i.year*i.isicmain, fe i(firmid) robust
testparm $instruments
local r=r(p)
outreg2 $instruments using `outpath', append `opt' addstat("p-value", `r')
* Column 3
xi: xtreg $dependent $instruments i.year*i.isicmain trend2a trend2b trend4a trend4b, fe i(firmid) robust
testparm $instruments
local r=r(p)
outreg2 $instruments using `outpath', append `opt' addstat("p-value", `r')
* Column 4
xi: xtreg $dependent $instruments i.year*i.isicmain trend1 trend3, fe i(firmid) robust
testparm $instruments
local r=r(p)
outreg2 $instruments using `outpath', append `opt' addstat("p-value", `r')
* Column 5
xi: xtreg $dependent $instruments lsales i.year*i.isicmain trend2a trend2b trend4a trend4b, fe i(firmid) robust
testparm $instruments
local r=r(p)
