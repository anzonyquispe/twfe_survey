...
\margl1440\margr1440\vieww13920\viewh16240\viewkind0
...
savereg, clear\
capture log close\
log using qdynamic_2002hosp.log,replace\
\
use monthlydata\
\
drop if year==2000\
...
gen treat8=(hmo1==1|hmo2==1) & (trend==21|trend==22|trend==23)\
...
\
*Omitted quarter is t-2\
drop treat3\
\
xtgls anyhosp treat1-treat11 pdum* tdum* [w=obs] if basic==0, corr(psar1) i(plans) t(trend) panels(heteroskedastic)\
\
savereg treat1\
savereg treat2\
savereg treat4\
...
\
\
table2a 1 "Dynamic - supp plans - omitted period: -6<t<-4" 1 10 "Any hosp" "-11<t<-10" "-9<t<-7" "-3<t<-1" "1<t<3" "4<t<6" "7<t<9" "10<t<12" "13<t<15" "16<t<18" "19<t<21"\
\
savereg, clear\
}