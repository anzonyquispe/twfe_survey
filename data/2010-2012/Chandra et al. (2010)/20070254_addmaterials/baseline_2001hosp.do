...
\margl1440\margr1440\vieww20480\viewh16600\viewkind0
...
savereg, clear\
capture log close\
log using baseline_2001hosp.log,replace\
\
\
...
\}\
\
table2a 1 "DD - supplemental plans - EXCLUDES T-1 & T+1" 1 5 "DD" "Any hosp" "Hosp days" "Totalpay hosp" "InsPay hosp" "McarePay hosp" \
savereg, clear\
}