...
clear;
cap log close;
log using disch94.log,replace;
set mem 900m;

/* 1994 - A version with individual ages*/
...
mvdriver mvped anyinj batter unint gun cut drown strang poison fight;

collapse (sum) preg* er assault suicide mv* anyinj batter unint gun cut 
drown strang poison fight, by (fips race age female poor);

sort fips race age female poor;

gen year=1994;

save disch94.dta,replace;
desc;
summ;
clear;
