...
prog main
	* robustness check of tenants treatment effect using individuals who lived ///
		in multi-family buildings with 5-10 units built post 1980 as control group
...
prog reg_main
	...
	global base_sample_control yr_built_treat>=1900 & yr_built_treat<=1990 & ///
...
prog write_esttab
	...
	esttab using "output/treat_collapse_`smpstub'_`ownstub'_altcontrol.csv", replace wide plain ///
