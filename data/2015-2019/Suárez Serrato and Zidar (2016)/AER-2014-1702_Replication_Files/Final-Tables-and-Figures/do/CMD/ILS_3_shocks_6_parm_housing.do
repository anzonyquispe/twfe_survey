...
esttab moment* using "$CMD_tablepath/moments_tax_6.csv", ///
...
esttab est_* using "$CMD_tablepath/struct_tax_6.csv", ///
...
graph export "$CMD_graphpath/contour_pi.pdf", replace
...
graph export "$CMD_graphpath/contour_alpha_pi.pdf", replace
