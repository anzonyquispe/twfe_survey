...
use "$dtapath/Tables/Appendix_Table31.dta", clear 
...
/**********************************/
/* Specifications for differences */
/**********************************/
local specnum=16
...
local Xcontrols13 = "D_taxratesales i.year i.fe_group"
local Xcontrols14 = "D_esrate_10 i.year i.fe_group"
local Xcontrols15 = "D_proptax i.year i.fe_group"
local Xcontrols16 = "D_taxratesales D_esrate_10 D_proptax i.year i.fe_group"
...
*********************************************************
use `results2_13', clear
forv spec=14/`specnum' {
sort rowid
merge 1:1 rowid using `results2_`spec''
tab _merge
drop _merge
}
gen agent="Workers $ \dot{w} - \alpha \dot{r}$" in 1
...
listtex using "Appendix_Table31.tex", replace rstyle(tabular)
