...
cd "$append_tablepath"
use "$dtapath/Tables/Appendix_Table13.dta", clear /* d_y = ln(f_non_trade_2) - ln(L10.f_non_trade_2) */

Table3, yvar(d_y) tax(d_bus_dom2) tablename(Appendix_Table13) cluster(fipstate) /* Appendix Table 13 */
