...
*********************************************************
* Sales tax rev per establishment
********************************************************* 
use "$dtapath/Figures/Appendix_Figure15.dta"
cd "$append_graphpath"

local xtitle="10 Year Log Change in Net of Business Tax Rate"
local ytitle= "10 Yr Log Chg in Sales Tax Rev per Establishment"
Binscatter10YR, yvar(D10_salestaxrev_E) tax(d_bus_dom2) figname(Appendix_Figure15) cluster(fipstate) ///
ytitle(`ytitle') xtitle(`xtitle')
