...
*Corporate change probit
use "$dtapath/Tables/Appendix_Table35.dta", clear

gen b = ""
gen se = ""
gen indepvars = " "
gen stars="" in 1 
probit I_D_corporate_rate other_corp_rate L(1/2).other_corp_rate payroll_wgt L(1/2).payroll_wgt income_rate_avg L(1/2).income_rate_avg L(0/1).income_pc_growth L(1/2).natl_unemp_rate, vce(r) 
matrix beta=e(b)
...
replace indepvars = "Mean Corporate Tax Rate of Other States" in 1
replace indepvars = "Mean Corporate Tax Rate of Other States ($ t-1$)" in 2
replace indepvars = "Mean Corporate Tax Rate of Other States ($ t-2$)" in 3
replace indepvars = "Payroll Weight" in 4
replace indepvars = "Payroll Weight ($ t-1$)" in 5
replace indepvars = "Payroll Weight ($ t-2$)" in 6
...
listtex using "Appendix_Table35.tex", replace rstyle(tabular)
