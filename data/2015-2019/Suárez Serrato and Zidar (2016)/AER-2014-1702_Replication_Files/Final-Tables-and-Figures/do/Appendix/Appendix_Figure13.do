...
use "$dtapath/Figures/Appendix_Figure13.dta"
cd "$append_graphpath"
...
binscatter y x, reportreg absorb(year) ///
 ytitle("10 Year Log Change in Composition Adj Rents") xtitle(" 10 Year Log Change in Net of Business Tax Rate ") ///
 note("Slope=  `A' (`se')", position(3) ring(0) size(medium)) 
graph export "Appendix_Figure13.pdf", replace
