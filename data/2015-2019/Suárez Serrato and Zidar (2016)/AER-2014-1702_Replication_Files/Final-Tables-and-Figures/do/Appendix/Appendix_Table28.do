...
use "$dtapath/Tables/Appendix_Table28.dta"
...
*****************
local specnum=4
local Xcontrols1 = "i.year i.fe_group Dlngdp Dlngdp_lag"
local Xcontrols2 = "i.year i.fips_state Dlngdp Dlngdp_lag"
local Xcontrols3 = "dtotalexpenditure_pop i.year i.fe_group Dlngdp Dlngdp_lag"
local Xcontrols4 = "bartik i.year i.fe_group Dlngdp Dlngdp_lag"
...
listtex using "Appendix_Table28.tex", replace rstyle(tabular)
