...
set seed 11002
use "$dtapath/Tables/Appendix_Table19.dta", replace 
...
*****************
local specnum=13
local Xcontrols1 = "throwback i.year i.fe_group"
local Xcontrols2 = "combined i.year i.fe_group"
local Xcontrols3 = "itc_state i.year i.fe_group"
local Xcontrols4 = "rec_val i.year i.fe_group"
local Xcontrols5 = "Losscarryback  i.year i.fe_group"
local Xcontrols6 = "Losscarryforward i.year i.fe_group"
local Xcontrols7 = "i.FranchiseTax i.year i.fe_group"
local Xcontrols8 =" i.deduct i.year i.fe_group"
local Xcontrols9 = "i.FederalIncomeasStateTaxBase i.year i.fe_group"
local Xcontrols10 = "i.AllowFedAccDep i.year i.fe_group"
local Xcontrols11 = "i.ACRSDepreciation dtotalexpenditure_pop i.year i.fe_group"
local Xcontrols12 = "i.FederalBonusDepreciation i.year i.fe_group"
local Xcontrols13 = "throwback combined itc_state rec_val Losscarryback Losscarryforward i.FranchiseTax i.deduct i.FederalIncomeasStateTaxBase i.AllowFedAccDep i.ACRSDepreciation i.FederalBonusDepreciation i.year i.fe_group"
...
*********************************************************
reg v1 tax `Xcontrols`spec''  [aw=epop]
local df=e(df_r)

if `spec' == 8 { /* If federal deductibility control is utilized */
	replace tax = d_t_corp_fed
}
...
listtex using "Appendix_Table19.tex", replace rstyle(tabular)
