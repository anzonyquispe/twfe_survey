...
*********************************************************
cd "$append_tablepath"
use "$dtapath/Tables/Appendix_Table11.dta", clear
keep if inlist(year, 1980, 1990, 2000, 2010)

Table3, yvar(D10_salestaxrev_E) tax(d_bus_dom2) tablename(Appendix_Table11) cluster(fipstate) /* Appendix Table 11 */
