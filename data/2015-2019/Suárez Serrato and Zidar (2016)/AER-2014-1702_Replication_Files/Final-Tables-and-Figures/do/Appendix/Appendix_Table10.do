...
*********************************************************
cd "$append_tablepath"
use "$dtapath/Tables/Appendix_Table10.dta", replace /* Note that d_y = ln(GOS_E) - ln(L10.GOS_E) */

Table3, yvar(d_y) tax(d_bus_dom2) tablename(Appendix_Table10) cluster(fipstate)/* Appendix Table 10 */
