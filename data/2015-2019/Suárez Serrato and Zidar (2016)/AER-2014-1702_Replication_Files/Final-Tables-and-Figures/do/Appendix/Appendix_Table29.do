...
use "$dtapath/Tables/Appendix_Table29.dta", clear
set seed 10504
...
drop if year == 1990 /*Removing 1990 from data and running same as prior table 4 creation*/
...
listtex using "Appendix_Table29.tex", replace rstyle(tabular)
