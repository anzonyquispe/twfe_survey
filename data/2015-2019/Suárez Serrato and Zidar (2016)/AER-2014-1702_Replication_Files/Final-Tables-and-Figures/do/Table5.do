...
program RFincidence
syntax, tax(varname) alpha(real) delta_gamma(real) spec(real) gamma(real) epd(real)

*********************************************************
*1. Select LHS and RHS variables
*********************************************************
use "$dtapath/Tables/Table5.dta", clear
******************
* LHS VARIABLES 
*****************
...
disp "eta"
nlcom  (_b[R2_mean:`tax']+_b[R1_mean:`tax'])/_b[R3_mean:`tax'] - 1
matrix A=r(b)
matrix B=r(V)
...
RFincidence, tax(d_bus_dom2) alpha(.3)  delta_gamma(.9) spec(1) gamma(.15) epd(-2.5)
RFincidence, tax(d_bus_dom2) alpha(.65)  delta_gamma(.9) spec(2) gamma(.15) epd(-2.5)
RFincidence, tax(d_bus_dom2) alpha(.3)  delta_gamma(.5) spec(3) gamma(.15) epd(-2.5)
RFincidence, tax(d_bus_dom2) alpha(.3)  delta_gamma(.9) spec(4) gamma(.15) epd(-2.5)
RFincidence, tax(d_bus_dom2) alpha(.3)  delta_gamma(.9) spec(5) gamma(.15) epd(-2.5)
RFincidence, tax(d_corp_orig) alpha(.3)  delta_gamma(.9) spec(6) gamma(.15) epd(-2.5)
