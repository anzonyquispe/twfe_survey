...
keep epop fips_state year conspuma dadjlwage dpop dadjlrent dest GovParty_D GovParty_I GovParty_R year fe_group throwback combined ///
	SalesTaxRate DSalesTaxRate income_rate_fam dtotalexpenditure_pop rev_corptax_gdp bartik deduct grt d_corp_orig Dincome_rate_fam

saveold "$dtapath/Tables/Appendix_Table21.dta", replace
