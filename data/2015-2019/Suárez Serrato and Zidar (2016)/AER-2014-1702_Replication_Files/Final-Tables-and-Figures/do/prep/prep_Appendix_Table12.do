...
sort conspuma year
tsset conspuma year
g d_y = ln(f_composite_index_2) - ln(L10.f_composite_index_2)

keep d_y f_composite_index_2 fipstate year epop fe_group d_keep_itc_state dtotalexpenditure_pop bartik d_corp_ext d_bus_dom2

saveold "$dtapath/Tables/Appendix_Table12.dta", replace
