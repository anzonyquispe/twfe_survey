...
insheet using ./sp/OptFlows0.csv, comma clear
g time=0
...
forvalues i = 1/11 {
	insheet using ./sp/OptFlows`i'.csv, comma clear
	g time=`i'
	rename v1 id_municipio
	rename v2 flows
	sort id_municipio time
...
cgmreg DummyConf DummyFlows YMoST* i.id_mun, cluster(id_mun SMnum) 
outreg2 DummyFlows using table6a, excel less(0) nocons replace bdec(3) adds(Clusters, e(N_clus1), "Mean", `mean')

summ ValueDom
local mean = r(mean)
	
cgmreg ValueDom DummyFlows YMoST* i.id_mun, cluster(id_mun SMnum) 
outreg2 DummyFlows using table6a, excel less(0) nocons append bdec(3) adds(Clusters, e(N_clus1), "Mean", `mean')

cgmreg ValueDom flows YMoST* i.id_mun, cluster(id_mun SMnum) 
outreg2 flows using table6a, excel less(0) nocons append bdec(3) adds(Clusters, e(N_clus1), "Mean", `mean')
...
cgmreg DummyCoc DummyFlows YMoST* i.id_mun, cluster(id_mun SMnum) 
outreg2 DummyFlows using table6a, excel less(0) nocons append bdec(3) adds(Clusters, e(N_clus1), "Mean", `mean')

summ ValueFor
local mean = r(mean)
	
cgmreg ValueFor DummyFlows YMoST* i.id_mun, cluster(id_mun SMnum) 
outreg2 DummyFlows using table6a, excel less(0) nocons append bdec(3) adds(Clusters, e(N_clus1), "Mean", `mean')

cgmreg ValueFor flows YMoST* i.id_mun, cluster(id_mun SMnum) 
outreg2 flows using table6a, excel less(0) nocons append bdec(3) adds(Clusters, e(N_clus1), "Mean", `mean')
