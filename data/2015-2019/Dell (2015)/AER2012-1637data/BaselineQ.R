...
data=read.csv("C:/Users/melissa.dell/Dropbox (Melissa Dell)/governance/reprod/BaselineQ.csv")
...
pdf(file ="C:/Users/melissa.dell/Dropbox (Melissa Dell)/governance/reprod/BaselineQ.pdf", width=14*.5, height=8*.5)
