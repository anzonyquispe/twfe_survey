...
outreg2 DummyFlows using table7_panelA, excel less(0) nocons replace bdec(3) adds(Clusters, e(N_clus1), "Mean", `mean')
...
outreg2 DummyFlows using table7_panelA, excel less(0) nocons append bdec(3) adds(Clusters, e(N_clus1), "Mean", `mean')
...
outreg2 flows using table7_panelA, excel less(0) nocons append bdec(3) adds(Clusters, e(N_clus1), "Mean", `mean')
...
outreg2 flow1 flow_g1 using table7_panelA, excel less(0) nocons append bdec(3) adds(Clusters, e(N_clus1), "Mean", `mean')
