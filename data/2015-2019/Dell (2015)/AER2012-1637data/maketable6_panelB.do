...
outreg2 DummyFlows using table6b, excel less(0) nocons replace bdec(3) adds(Clusters, e(N_clus1), "Mean", `mean')

summ ValueDom
local mean = r(mean)
	
cgmreg ValueDom DummyFlows YMoST* i.id_mun, cluster(id_mun SMnum) 
outreg2 DummyFlows using table6b, excel less(0) nocons append bdec(3) adds(Clusters, e(N_clus1), "Mean", `mean')

cgmreg ValueDom flows YMoST* i.id_mun, cluster(id_mun SMnum) 
outreg2 flows using table6b, excel less(0) nocons append bdec(3) adds(Clusters, e(N_clus1), "Mean", `mean')
