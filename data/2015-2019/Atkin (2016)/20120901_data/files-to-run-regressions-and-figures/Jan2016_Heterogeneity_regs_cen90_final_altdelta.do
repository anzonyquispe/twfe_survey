...
foreach style in 6b {  
local feenstra "delta`style'"
foreach dnum of numlist 9 {    
local dvar "d`dnum'"


foreach sexer in emp  {  
...
local ifster " & (state!=20 | (state==20 & meaneclwtyrschl>25 & badcluster!=1))" 
...
local namer "Jan2016`agespan'_`yrstart'_`perclist'_`feenstra'_d`style'q`dvar'_`sexer'_`export'_`mainspec'_`agey'_`wager'_`lagfav'"
local middle "_none"
if `agespan'==1516 {
local filend "" 
}
...
***********************************************************************************************
*Tables 7-10 Are exports different?
***********************************************************************************************
...
local nonexportpure=`export'+1
}
else {
global nonexportpure=15
}
...
(eclyrschlprop78_1990-(eschatgrade`agey'_90_12-eschatgrade`agey'_90_13))
(eclyrschlprop1212_1990-(eschatgrade`agey'_90_17-eschatgrade`agey'_90_18))
(eclyrschlprop1011_1990-(eschatgrade`agey'_90_15-eschatgrade`agey'_90_16))
(eschatgrade`agey'_90_17-eschatgrade`agey'_90_18)
(eschatgrade`agey'_90_15-eschatgrade`agey'_90_16)
"
...
if "`sexer'"=="male" {  
local wageperced "m`wage'`mperced'"
}
else {
local wageperced "`wage'`perced'"
}
...
local snamer "`interactee1' `interactee2' `interactee3'"
...
#delimit ;
global shocker `"    
"`lhs'\`lgender'\`lgender3'`perc'c1`type'9`sklgeo'_50 `lhs'\`lgender'\`lgender3'`perc'c2`type'9`sklgeo'_50 `lhs'\`lgender'\`lgender3'`perc'c3`type'9`sklgeo'_50"  
"' ; 
global randomuse "
...
q\`aget'`lhs'\`lgender'*`wageperced'c??9`sklgeo'_50`nonexport'${mpop}
q\`aget'`lhs'\`lgender'*`wageperced'c??9`sklgeo'_50`export'${mpop} 
q\`aget'`lhs'\`lgender'*`wageperced'c??9`sklgeo'_50${nonexportpure}${mpop} 
";
global interactuse "
`stripinteractunique'
";
...
global codeinsert38 "cap mvencode q*demp*`nonexport'${mpop} if q\`aget'`lhs'\`lgender'50`nonexport'${mpop}==0, mv(0) override"
...
global codeinsert48 "gen complex1\`lgender'`dvar'`wageperced'c1`type'9`sklgeo'_50`nonexport'${mpop}=q\`aget'`lhs'\`lgender'`wageperced'c1`type'9`sklgeo'_50`nonexport'${mpop}*complex1"
global codeinsert49 "gen complex2\`lgender'`dvar'`wageperced'c2`type'9`sklgeo'_50`nonexport'${mpop}=q\`aget'`lhs'\`lgender'`dvar'`wageperced'c2`type'9`sklgeo'_50`nonexport'${mpop}*complex2"
global codeinsert50 "gen complex3\`lgender'`dvar'`wageperced'c2`type'9`sklgeo'_50`nonexport'${mpop}=q\`aget'`lhs'\`lgender'`dvar'`wageperced'c2`type'9`sklgeo'_50`nonexport'${mpop}*complex3+q\`aget'`lhs'\`lgender'`wageperced'c2`type'9`sklgeo'_50`nonexport'${mpop}*complex5"
global codeinsert51 "gen complex4\`lgender'`dvar'`wageperced'c3`type'9`sklgeo'_50`nonexport'${mpop}=(q\`aget'`lhs'\`lgender'2`dvar'`wageperced'c3`type'9`sklgeo'_50`nonexport'${mpop}*complex4+q\`aget'`lhs'\`lgender'`dvar'`wageperced'c3`type'9`sklgeo'_50`nonexport'${mpop}*complex6)"

global codeinsert52 "gen complex1\`lgender'`dvar'`wageperced'c1`type'9`sklgeo'_50`export'${mpop}=q\`aget'`lhs'\`lgender'`wageperced'c1`type'9`sklgeo'_50`export'${mpop}*complex1"
global codeinsert53 "gen complex2\`lgender'`dvar'`wageperced'c2`type'9`sklgeo'_50`export'${mpop}=q\`aget'`lhs'\`lgender'`dvar'`wageperced'c2`type'9`sklgeo'_50`export'${mpop}*complex2"
global codeinsert54 "gen complex3\`lgender'`dvar'`wageperced'c2`type'9`sklgeo'_50`export'${mpop}=q\`aget'`lhs'\`lgender'`dvar'`wageperced'c2`type'9`sklgeo'_50`export'${mpop}*complex3+q\`aget'`lhs'\`lgender'`wageperced'c2`type'9`sklgeo'_50`export'${mpop}*complex5"
global codeinsert55 "gen complex4\`lgender'`dvar'`wageperced'c3`type'9`sklgeo'_50`export'${mpop}=(q\`aget'`lhs'\`lgender'2`dvar'`wageperced'c3`type'9`sklgeo'_50`export'${mpop}*complex4+q\`aget'`lhs'\`lgender'`dvar'`wageperced'c3`type'9`sklgeo'_50`export'${mpop}*complex6)"

global codeinsert56 "gen complex1\`lgender'`dvar'`wageperced'c1`type'9`sklgeo'_50`nonexportpure'${mpop}=q\`aget'`lhs'\`lgender'`wageperced'c1`type'9`sklgeo'_50`nonexportpure'${mpop}*complex1"
global codeinsert57 "gen complex2\`lgender'`dvar'`wageperced'c2`type'9`sklgeo'_50`nonexportpure'${mpop}=q\`aget'`lhs'\`lgender'`dvar'`wageperced'c2`type'9`sklgeo'_50`nonexportpure'${mpop}*complex2"
global codeinsert58 "gen complex3\`lgender'`dvar'`wageperced'c2`type'9`sklgeo'_50`nonexportpure'${mpop}=q\`aget'`lhs'\`lgender'`dvar'`wageperced'c2`type'9`sklgeo'_50`nonexportpure'${mpop}*complex3+q\`aget'`lhs'\`lgender'`wageperced'c2`type'9`sklgeo'_50`nonexportpure'${mpop}*complex5"
global codeinsert59 "gen complex4\`lgender'`dvar'`wageperced'c3`type'9`sklgeo'_50`nonexportpure'${mpop}=(q\`aget'`lhs'\`lgender'2`dvar'`wageperced'c3`type'9`sklgeo'_50`nonexportpure'${mpop}*complex4+q\`aget'`lhs'\`lgender'`dvar'`wageperced'c3`type'9`sklgeo'_50`nonexportpure'${mpop}*complex6)"
...
"q\`aget'`lhs'\`lgender'50`export'${mpop}
complex1\`lgender'`dvar'`wageperced'c1`type'9`sklgeo'_50`export'${mpop}
complex2\`lgender'`dvar'`wageperced'c2`type'9`sklgeo'_50`export'${mpop}
complex3\`lgender'`dvar'`wageperced'c2`type'9`sklgeo'_50`export'${mpop}
complex4\`lgender'`dvar'`wageperced'c3`type'9`sklgeo'_50`export'${mpop}
"


"q\`aget'`lhs'\`lgender'50`nonexport'${mpop}
complex1\`lgender'`dvar'`wageperced'c1`type'9`sklgeo'_50`nonexport'${mpop}
complex2\`lgender'`dvar'`wageperced'c2`type'9`sklgeo'_50`nonexport'${mpop}
complex3\`lgender'`dvar'`wageperced'c2`type'9`sklgeo'_50`nonexport'${mpop}
complex4\`lgender'`dvar'`wageperced'c3`type'9`sklgeo'_50`nonexport'${mpop}
"
...
"q\`aget'`lhs'\`lgender'\`lgender3'`perc'c1`type'9`sklgeo'_50`nonexport'${mpop}
...
q\`aget'`lhs'\`lgender'\`lgender3'`perc'c4`type'9`sklgeo'_50`nonexport'${mpop}
