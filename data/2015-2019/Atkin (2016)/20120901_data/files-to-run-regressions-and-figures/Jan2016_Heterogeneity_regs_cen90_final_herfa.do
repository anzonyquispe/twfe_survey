...
q\`aget'd\`lgender'50${nonexportpure}${mpop}
...
global file "_genericskill_`feenstra'_herfacen90`filend'"



*so h/f are men or all
*so m/n are no migrants or all
*so e/n/a are exp, normal and all sample 
*9m/9s means that averages are at mun/state level
*0 type set outside wage to zero, otherwise half the 6 years of school wage
