...
infix ///
 ...
 long    munimx                              21-25 ///
 byte    sizemx                              26 ///
 long    mx05a_munic                         27-31 ///
 byte    mx05a_metzone                       32-33 ///
 int     pernum                              34-36 ///
 float   wtper                               37-44 ///
 int     age                                 45-47 ///
 byte    sex                                 48 ///
 ...
 byte    mgrate5                             59-60 ///
 byte    mx05a_insim                         61 ///
 byte    mx05a_respr                         62-63 ///
 using datkin_princeton_edu_010.dat
...
label var mx05a_munic `"Municipality or delegation"'
label var mx05a_metzone `"Metropolitan zone"'
...
label var mx05a_respr `"Place of residence in October 2000"'
...
label values mx05a_munic mx05a_municlbl

label define mx05a_metzonelbl 01 `"Aguascalientes"'
label define mx05a_metzonelbl 02 `"Tijuana"', add
label define mx05a_metzonelbl 03 `"Monclova-Frontera"', add
label define mx05a_metzonelbl 04 `"Piedras Negras"', add
label define mx05a_metzonelbl 05 `"Salitillo"', add
label define mx05a_metzonelbl 06 `"La Laguna"', add
label define mx05a_metzonelbl 07 `"Colima-Villa de Alvarez"', add
label define mx05a_metzonelbl 08 `"Tecoman"', add
label define mx05a_metzonelbl 09 `"Tuxtla Gutierrez"', add
label define mx05a_metzonelbl 10 `"Chihuahua"', add
label define mx05a_metzonelbl 11 `"Juarez"', add
label define mx05a_metzonelbl 12 `"Valle de Mexico"', add
label define mx05a_metzonelbl 13 `"Moroleon-Uraingato"', add
label define mx05a_metzonelbl 14 `"Leon"', add
label define mx05a_metzonelbl 15 `"San Francisco del Rincon"', add
label define mx05a_metzonelbl 16 `"Acapulco"', add
label define mx05a_metzonelbl 17 `"Pachuca"', add
label define mx05a_metzonelbl 18 `"Tulancingo"', add
label define mx05a_metzonelbl 19 `"Tula"', add
label define mx05a_metzonelbl 20 `"Guadalajara"', add
label define mx05a_metzonelbl 21 `"Ocotlan"', add
label define mx05a_metzonelbl 22 `"Puerto Vallarta"', add
label define mx05a_metzonelbl 23 `"Toluca"', add
label define mx05a_metzonelbl 24 `"Zamora-Jacona"', add
label define mx05a_metzonelbl 25 `"La Piedad"', add
label define mx05a_metzonelbl 26 `"Morelia"', add
label define mx05a_metzonelbl 27 `"Cuautla"', add
label define mx05a_metzonelbl 28 `"Cuernavaca"', add
label define mx05a_metzonelbl 29 `"Tepic"', add
label define mx05a_metzonelbl 30 `"Monterrey"', add
label define mx05a_metzonelbl 31 `"Oaxaca"', add
label define mx05a_metzonelbl 32 `"Puebla-Tlaxcala"', add
label define mx05a_metzonelbl 33 `"San Martin Texmelucan"', add
label define mx05a_metzonelbl 34 `"Queretaro"', add
label define mx05a_metzonelbl 35 `"Cancun"', add
label define mx05a_metzonelbl 36 `"Rioverde-Ciudad Fernandez"', add
label define mx05a_metzonelbl 37 `"San Luis Potosí-Soledad"', add
label define mx05a_metzonelbl 38 `"Guaymas"', add
label define mx05a_metzonelbl 39 `"Villahermosa"', add
label define mx05a_metzonelbl 40 `"Tampico"', add
label define mx05a_metzonelbl 41 `"Matamoros"', add
label define mx05a_metzonelbl 42 `"Nuevo Laredo"', add
label define mx05a_metzonelbl 43 `"Reynosa-Rio Bravo"', add
label define mx05a_metzonelbl 44 `"Apizaco"', add
label define mx05a_metzonelbl 45 `"Tlaxcala"', add
label define mx05a_metzonelbl 46 `"Acayucan"', add
label define mx05a_metzonelbl 47 `"Coatzacoalcos"', add
label define mx05a_metzonelbl 48 `"Minatitlan"', add
label define mx05a_metzonelbl 49 `"Cordoba"', add
label define mx05a_metzonelbl 50 `"Xalapa"', add
label define mx05a_metzonelbl 51 `"Orizaba"', add
label define mx05a_metzonelbl 52 `"Poza Rica"', add
label define mx05a_metzonelbl 53 `"Veracruz"', add
label define mx05a_metzonelbl 54 `"Merida"', add
label define mx05a_metzonelbl 55 `"Zacatecas-Guadalupe"', add
label define mx05a_metzonelbl 56 `"Not in metropolitan area"', add
label values mx05a_metzone mx05a_metzonelbl
...
label define chbornlbl 99 `"NIU (not in universe)"', add
...
label define chsurvlbl 99 `"NIU (not in universe)"', add
...
label define mx05a_resprlbl 01 `"Aguascalientes"'
label define mx05a_resprlbl 02 `"Baja California"', add
label define mx05a_resprlbl 03 `"Baja California sur"', add
label define mx05a_resprlbl 04 `"Campeche"', add
label define mx05a_resprlbl 05 `"Coahuila de Zaragoza"', add
label define mx05a_resprlbl 06 `"Colima"', add
label define mx05a_resprlbl 07 `"Chiapas"', add
label define mx05a_resprlbl 08 `"Chihuahua"', add
label define mx05a_resprlbl 09 `"Distrito Federal"', add
label define mx05a_resprlbl 10 `"Durango"', add
label define mx05a_resprlbl 11 `"Guanajuato"', add
label define mx05a_resprlbl 12 `"Guerrero"', add
label define mx05a_resprlbl 13 `"Hidalgo"', add
label define mx05a_resprlbl 14 `"Jalisco"', add
label define mx05a_resprlbl 15 `"México"', add
label define mx05a_resprlbl 16 `"Michoacán de Ocampo"', add
label define mx05a_resprlbl 17 `"Morelos"', add
label define mx05a_resprlbl 18 `"Nayarit"', add
label define mx05a_resprlbl 19 `"Nuevo León"', add
label define mx05a_resprlbl 20 `"Oaxaca"', add
label define mx05a_resprlbl 21 `"Puebla"', add
label define mx05a_resprlbl 22 `"Querétaro de Arteaga"', add
label define mx05a_resprlbl 23 `"Quintana Roo"', add
label define mx05a_resprlbl 24 `"San Luis Potosí"', add
label define mx05a_resprlbl 25 `"Sinaloa"', add
label define mx05a_resprlbl 26 `"Sonora"', add
label define mx05a_resprlbl 27 `"Tabasco"', add
label define mx05a_resprlbl 28 `"Tamaulipas"', add
label define mx05a_resprlbl 29 `"Tlaxcala"', add
label define mx05a_resprlbl 30 `"Veracruz de Ignacio de la Llave"', add
label define mx05a_resprlbl 31 `"Yucatán"', add
label define mx05a_resprlbl 32 `"Zacatecas"', add
label define mx05a_resprlbl 33 `"Insufficiently specified"', add
label define mx05a_resprlbl 40 `"United States of America"', add
label define mx05a_resprlbl 98 `"Other country"', add
label define mx05a_resprlbl 99 `"NIU (not in universe)"', add
label values mx05a_respr mx05a_resprlbl

save mexico_censo_10.dta, replace
