...
****here is where i drop all herfindhals <0.1 
merge m:1 grupo using "`dir'state_herfindahls_grupos.dta", keep(match master) 
drop _merge
keep if staherfindahlgrupo>=0.1 & staherfindahlgrupo!=.
drop staherfindahlgrupo
...
save  "`scratch'firmdata_hcodeherfacen90indtotals.dta", replace
...
renpfix delta deltahfa
renpfix emp hfaemp
renpfix male hfamale
renpfix fem hfafem
renpfix firm hfafirm
