...
gen     anst_13kat=.
replace anst_13kat= 1 if (ast>=1000 & ast<5000) 
replace anst_13kat= 2 if ast>=5000 & ast<10000
replace anst_13kat= 3 if ast>=10000 & ast<15000
replace anst_13kat= 4 if ast>=15000 & ast<40000
replace anst_13kat= 5 if ast>=40000 & ast<45000
replace anst_13kat= 6 if ast>=50000 & ast<55000
replace anst_13kat= 7 if ast>=55000 & ast<60000
replace anst_13kat= 8 if ast>=60000 & ast<65000
replace anst_13kat= 9 if ast>= 65000 & ast<70000
replace anst_13kat= 10 if ast>= 70000 & ast<75000
replace anst_13kat= 11 if ast>=75000 & ast<80000
replace anst_13kat= 12 if ast>=80000 & ast<85000
replace anst_13kat= 13 if ast>=90000 & ast<96000
replace anst_13kat= 11 if ast==99000
...
tab m_id, gen(dum_k)
egen ast3_hog= group (anst_13kat educ_year alder_5cat_ep)
