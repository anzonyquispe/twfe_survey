...
# Median for Coefficients
/share/apps/matlab/2014a/bin/matlab -nodisplay -nojvm -r "asi_simulation10($PBS_ARRAYID,4.5,7)"
rsync -avuz /scratch/acw6/aco/matlab/simulation_asi_inputs_dec2014/*.* dhcp-152-3-10-134.econ.duke.edu:~/Dropbox/India_Power_Shortages/matlab/simulation_asi_inputs_dec2014/

# Not Median for Coefficients
/share/apps/matlab/2014a/bin/matlab -nodisplay -nojvm -r "asi_simulation10($PBS_ARRAYID,4.5,18)"
rsync -avuz /scratch/acw6/aco/matlab/simulation_asi_inputs_dec2014/*.* dhcp-152-3-10-134.econ.duke.edu:~/Dropbox/India_Power_Shortages/matlab/simulation_asi_inputs_dec2014/
