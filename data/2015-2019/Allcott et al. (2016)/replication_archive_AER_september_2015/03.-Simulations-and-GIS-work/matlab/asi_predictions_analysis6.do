...
capture program drop asi_predictions_analysis6
program define asi_predictions_analysis6, eclass
quietly {
...
sum delta_psp  [aweight=mult], meanonly
...
sum  diff_tfp [aweight=mult], meanonly
scalar diff_tfp=r(mean)
sum  diff_tfp if zero_generation==0 [aweight=mult], meanonly
scalar diff_tfp_gen=r(mean)
sum  diff_tfp if zero_generation==1 [aweight=mult], meanonly
scalar diff_tfp_nogen=r(mean)

sum  pctshortage [aweight=mult], meanonly
...
sum  pctshortage if zero_generation==0 [aweight=mult], meanonly
scalar output_loss_gen=r(mean)

sum  pctshortage if zero_generation==1 [aweight=mult], meanonly
...
sum  pct_change_mat [aweight=mult], meanonly
...
sum  pct_self_gen [aweight=mult], meanonly
...
sum  profit_diff_shortage [aweight=mult], meanonly
scalar profit_diff_shortage=r(mean)

sum  profit_diff_shortage if zero_generation==0 [aweight=mult], meanonly
scalar profit_loss_gens=r(mean)

sum  profit_diff_shortage if zero_generation==1 [aweight=mult], meanonly
...
// Weighted Average
sum  buy_generator [aweight=mult], meanonly
...
corr buy_generator log_gen_size [aweight=mult], covariance
matrix A=r(C)
...
sum  elasticity [aweight=mult], meanonly
...
sum  total_prod [aweight=mult], meanonly
...
sum  total_grid [aweight=mult], meanonly
scalar grid_power=r(mean)

gen diff_endo=100*(y_no_shortage-y_endo)/y_no_shortage
sum  diff_endo [aweight=mult], meanonly
scalar diff_endo=r(mean)

sum  diff_endo if buy_generator==0 [aweight=mult], meanonly
...
sum  diff_endo if buy_generator==1 [aweight=mult], meanonly
...
sum  tfp_endo [aweight=mult], meanonly
scalar tfp_endo=r(mean)


sum  tfp_endo if buy_generator==0 [aweight=mult], meanonly
scalar tfp_endo_gen=r(mean)
local flag=r(mean)
if  `flag'==. {
scalar tfp_endo_gen=-99
}
sum  tfp_endo if buy_generator==1 [aweight=mult], meanonly
...
sum  pdiff_endo [aweight=mult], meanonly
scalar profit_endo=r(mean)


sum  pdiff_endo if buy_generator==0 [aweight=mult], meanonly
...
sum  pdiff_endo if buy_generator==1 [aweight=mult], meanonly
...
sum  profit_diff_short_nobody_gen [aweight=mult], meanonly
...
sum  input_cost if zero_generation==0 [aweight=mult], meanonly
scalar input_cost_exo=r(mean)

sum  input_cost if buy_generator==1 [aweight=mult], meanonly
...
// Generator Stuff
sum  ratio_gen_cost_to_profit_exo  if ratio_gen_cost_to_profit_exo<90 [aweight=mult], meanonly
...
sum  ratio_gen_cost_to_profit_exo if zero_generation==0 [aweight=mult], meanonly
...
sum  ratio_gen_cost_to_profit_endo  if ratio_gen_cost_to_profit_endo<90 [aweight=mult], meanonly
...
sum  ratio_gen_cost_to_profit_endo  if ratio_gen_cost_to_profit_endo<90 & buy_generator==1 [aweight=mult], meanonly
