...
/*
For years 2008-2010 the variables Bonus, Provident and Welfare were not 
recorded correctly since they were not under the "Total employees (5+6+7+8)" 
category but under a separate category called "10". 
This field was not used in our work.
*/;