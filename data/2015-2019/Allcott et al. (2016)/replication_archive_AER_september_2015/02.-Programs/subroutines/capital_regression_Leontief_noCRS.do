...
// Data file
use panelgroup year lshare_leontief mshare_leontief eshare_leontief lnY lnM lnL lnK lnE nic87 nic87_super using "$work/temp2.dta" , clear //adjusted SOC
...
disp("end")
drop snic2
collapse (count) count_plants=lnY, by(year nic87 nic87_super mshare_leontief lshare_leontief eshare_leontief betak sebetak)
outsheet using "$work/coefficients by nic-year_Nov2014_leontief.csv", comma names replace
keep betak nic87_super
duplicates drop
rename betak betak_leontief_noCRS
