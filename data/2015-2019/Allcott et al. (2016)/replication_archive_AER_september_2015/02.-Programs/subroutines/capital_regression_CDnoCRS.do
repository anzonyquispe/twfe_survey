...
// Data file
use panelgroup year lshare_final mshare_final eshare_final lnY lnM lnL lnK lnE nic87 nic87_super using "$work/temp2.dta" , clear //adjusted SOC
...
disp("end")
drop snic2
collapse (count) count_plants=lnY, by(year nic87 nic87_super mshare_final lshare_final eshare_final betak sebetak)
outsheet using "$work/coefficients by nic-year_Nov2014_step1.csv", comma names replace
keep betak nic87_super
duplicates drop
